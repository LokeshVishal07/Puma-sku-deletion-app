...
Output: one row per Seller SKU with Article No, Product Title, stock at each
checkpoint, and a `Delete = YES / NO / REVIEW` verdict with a plain-English
reason — downloadable as an Excel file.
